...
**Target**: `/home/avi/orbital-sentinel/`
...
**Files**: 
- `/home/avi/orbital-sentinel/platform/cre_analyze_endpoint.py` lines 650-656, 695-762
...
**Files**:
- `/home/avi/orbital-sentinel/workflows/price-feeds/my-workflow/main.ts` lines 239-247
- `/home/avi/orbital-sentinel/workflows/curve-pool/my-workflow/main.ts` lines 268-274
...
**File**: `/home/avi/orbital-sentinel/workflows/token-flows/my-workflow/main.ts` line 303
...
**Files**:
- `/home/avi/orbital-sentinel/contracts/SentinelRegistry.ts`
...
**File**: `/home/avi/orbital-sentinel/scripts/record-all-snapshots.mjs` line 259
...
**Discovery Path**: State Pass 2 (3B: Parallel Path Comparison)
**Files**:
- `/home/avi/orbital-sentinel/workflows/curve-pool/my-workflow/main.ts` lines 38-39 (configurable thresholds)
- `/home/avi/orbital-sentinel/scripts/record-all-snapshots.mjs` lines 226-229 (hardcoded thresholds)
