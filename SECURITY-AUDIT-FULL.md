...
Password (URL-decoded: `Mbwet/F/7ENsFDXOgd8HJOOC1JJwQsL5`) is visible in the public repo. If PostgreSQL is ever reachable externally (misconfigured firewall, tunnel, port forward), full database access is possible.
