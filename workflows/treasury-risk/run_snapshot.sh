...
SNAPSHOT_PATH="${SNAPSHOT_PATH:-${ROOT_DIR}/../../intelligence/data/sentinel_treasury_snapshot.json}"
...
def parse_output(text: str) -> dict | None:
    ...
    required = {"timestamp", "chainName", "staking"}
...
print(f"Wrote treasury snapshot to {snapshot_path}")
PY
